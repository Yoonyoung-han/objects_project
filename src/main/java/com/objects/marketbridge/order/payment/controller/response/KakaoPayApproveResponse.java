package com.objects.marketbridge.order.payment.controller.response;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.objects.marketbridge.order.payment.domain.Amount;
import com.objects.marketbridge.order.payment.domain.CardInfo;
